...
The results in Fig. \@ref(fig:maskspacing) suggest that, for a uniform density model, any mask spacing less than the half-normal $\sigma$ is adequate; $0.6\sigma$ provides a considerable safety margin. The effect of detector spacing on the relationship has not been examined. Referring back to Fig. \@ref(fig:maskpoints), a mask of about 1000 points will usually be adequate with a $4\sigma$ buffer.
