...
::: {.callout-note}
## Subsets
Avoid using '[' to extract subsets from mask, capthist and other **secr** objects. Use the provided `subset` methods. It is generally safe to use '[[' to extract one session from a multi-session capthist object. 
:::
...
### `details` -- miscellaneous arguments  {#details}
...
See the `details` [help page](https://www.otago.ac.nz/density/html/details.html) for a full list and description.
