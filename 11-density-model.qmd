...
Theory for relative density models was given [earlier](03-theory.qmd#sec-relativedensity1) (see also [@Efford2025]). A spatial model for relative density is fitted in **secr** by setting `CL = TRUE` and providing a model for D in the call to `secr.fit` (**secr** $\ge$ 5.2.0). For example
