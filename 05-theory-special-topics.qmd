...
The most important of these are the linear submodels for [detection](10-detection-model.qmd#linear-submodels) and [density](11-density-model.qmd#sec-density) that we describe in their respective chapters. Others we list here.
