...
The most important of these are the linear sub-models for [detection](10-detection-model.qmd#linear-submodels) and [density](11-density-model.qmd#sec-density) that we describe in their respective chapters. Others we list here.
...
A later [section](11-density-model.qmd#not-a-density-surface) discusses the use and interpretation of $f(\mathbf x | \omega_i; \hat \phi, \hat \theta)$ [see also @Durbach2024].
