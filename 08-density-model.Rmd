...
```{r OVdtr, eval = TRUE, fig.width = 6, fig.height = 5, out.width="95%", fig.cap = "Possum density vs distance to river: regression spline *k* = 3" }
...
```{r CIplot, eval = TRUE, fig.width = 6, fig.height = 5, out.width="95%", fig.cap = "Confidence surfaces"}
...
```{r relativeD3, fig.width = 6, fig.height = 5, out.width="95%", fig.cap = "Orongorongo Valley relative density of tagged possums"}
# compare and plot
