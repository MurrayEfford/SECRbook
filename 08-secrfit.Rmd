...
AIC~c~ is widely used and it is the default criterion in **secr**. However, doubts about the correct sample size, and simulation results for generalised linear models cited by @Fletcher2019[p. 60], lead us to use AIC in this book.
