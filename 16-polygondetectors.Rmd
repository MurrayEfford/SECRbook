...
```{r FTHLplot, fig.width = 4, fig.height = 4, message = FALSE, fig.cap = "(ref:FTHLplotcap)"}
par(mar=c(1,1,2,1))
...
```{r cueplot2, echo = TRUE, eval=TRUE, fig.width = 5, fig.cap = "(ref:cueplot2cap)"}
par(mar = c(1,2,3,2))
...
Post-hoc discretization is also considered by @Russell2012 and @Milleret2018.
...
```{r transectmask, echo = TRUE, eval = TRUE, fig.cap = "(ref:transectmaskcap)"}
...
```{r irregular, echo = FALSE, out.width = "90%", fig.cap = "(ref:irregularcap)"}
