...
::: {.callout-tip}
Do not use unprojected geographic coordinates (latitude and longitude). Conversion of geographic coordinates to rectangular coordinates (e.g., UTM) is described in an [appendix](A03-spatial-data.qmd#sec-inputspatialdata).
:::
