...
# It is not strictly necessary to run this in every chapter after the first, but it makes 
# debugging easier, as each chapter may be knitted independently

library(secr)
setNumThreads(18)
hareCH6 <- read.capthist("data/hareCH6capt.txt", "data/hareCH6trap.txt", detector = "single")
options(digits = 5, width = 85)       
