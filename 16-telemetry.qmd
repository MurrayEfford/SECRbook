...
## Lists of telemetry-related functions.  {#sec-telemetryappendix2}
...
`*` these functions use the telemetry coordinates if the capthist is telemetry-only, 
otherwise the detection sites
