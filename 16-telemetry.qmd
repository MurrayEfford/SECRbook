...
: Functions specifically for telemetry data. Functions marked with an asterisk (*) use the telemetry coordinates if the capthist is telemetry-only, otherwise the detection sites. {#tbl-telemetryfunctions .sm}
...
: Telemetry-ready general functions.  {#tbl-telemetrygeneralfunctions .sm}
