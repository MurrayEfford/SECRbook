...
Robustness to the failure of a specific assumption is easily assessed by simulation, and there have now been several studies that we review below and supplement with simulations explained at greater length [elsewhere]. 
...
(ref:MID3cap) Relative bias of parameter estimates from null model when some individuals cannot be distinguished ("shadow effects"). Shaded band: |RB| < 10%. Simulation details on [Github](https://htmlpreview.github.io/?https://github.com/MurrayEfford/secr-simulations/blob/main/MID/secr-simulations-MID.html).
