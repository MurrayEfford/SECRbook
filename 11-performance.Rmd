...
abline(h=0, lty=2)
points(taulevels, estD$RB[-1], type='o', pch=16, cex=1.1)
points(taulevels, estS$RB[-1], type='o', pch=21, bg = 'white', cex = 1.1)
...
abline (h = 0, lty = 2)
points(moves, estD$RB, pch = 16, type = 'o', cex = 1.1)
points(moves, estL$RB, pch = 21, bg = 'white', type = 'o', cex=1.1)
points(moves, estS$RB, pch = 24, bg = 'white', type = 'o')
...
abline(h=0, lty=2)
points(x, estD$RB[1:5], type='o', pch=16, cex=1.1)
points(x, estL$RB[1:5], type='o', pch=21, bg = 'white', cex=1.1)
points(x, estS$RB[1:5], type='o', pch=24, bg = 'white')
...
abline(h=0, lty=2)
points(x, estD$RB[c(1,6:9)], type='o', pch=16, cex=1.1)
points(x, estL$RB[c(1,6:9)], type='o', pch=21, bg = 'white', cex=1.1)
points(x, estS$RB[c(1,6:9)], type='o', pch=24, bg = 'white')
legend(0.01, 0.39, legend = leg, pch=c(16,21,24), pt.cex=c(1.2,1.2,1))
```
...
abline(h=0, lty=2)
points(x, estL$RB[1:5], type='o', pch=21, bg = 'white')
points(x, estS$RB[1:5], type='o', pch=24, bg = 'white')
...
plot(0,0,type='n', xlim=c(0,2), ylim=c(-0.8,1), xlab = 'Recapture factor', ylab='RB')
abline(h=0, lty=2)
points(x, estL$RB[6:10], type='o', pch=21, bg = 'white')
points(x, estS$RB[6:10], type='o', pch=24, bg = 'white')
...
points(x, estL$RB[c(1,6:9)], type='o', pch=21, bg = 'white')
points(x, estS$RB[c(1,6:9)], type='o', pch=24, bg = 'white')
legend(0.03, 0.48, legend=leg, pch=c(16,21,24), cex = 0.9, pt.cex=c(1.1,1.1,1))
```
...
General satisfaction with SECR MAYBE LEAD WITH THIS?
...
[Homogeneity across individuals](#individualheterogeneity)  
[Homogeneity across detectors](#homogeneityofdetectors)  
5. Individuals are detected independently of each other  
[Mutual indepenence](#independentindividuals)  
6. Each detection of an individual is independent of other detections  
