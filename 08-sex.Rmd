...
We suggest the decision chart in Fig. \@ref(fig:chart). This omits 'session' approaches that we previously included for [comparison](#demonstration) because they are rather clunky in practice and group models are equivalent.
...
```{r chart, echo = FALSE, out.height="350pt", out.width="500pt", include = TRUE, fig.cap="Decision chart for including sex in detection model. 'sexcov' is a character value naming a 2-level character or factor individual covariate"}
