...
fitsl <- mapply(secr.fit, start = starts, SIMPLIFY = FALSE, MoreArgs = list(
   capthist = morning, model = lambda0~h2, buffer = 25, detectfn = 'HEX', trace = FALSE))
fitsl <- secrlist(fitsl, names=c('start1', 'start2'))
