...
::: {.callout-warning}
Not all detector types and options in **secr** will work with mark--resight data. See [Limitations](#MRlimitations) for a list of known constraints (some will be mentioned along the way). See the [step-by-step guide](#sec-appendix1) for a quick introduction.
:::
...
* [hybrid mixtures](05-theory-special-topics.qmd#sec-hybrid-mixtures) with known class membership ('hcov') have not been implemented for mark-resight data
