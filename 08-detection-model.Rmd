...
```{r choicedfplot, echo = FALSE, fig.width = 4.5, fig.height = 5, out.width="60%", fig.cap = "Four detection functions fitted to snowshoe hare data"}
...
```{r HVPvaryzplot, echo = FALSE, fig.width = 4.5, fig.height = 5, out.width="60%", fig.cap="HVP function fitted to snowshoe hare data with $z$ parameter fixed at four different values", results = "hide"}
par(cex = 0.85, pty = 's')
