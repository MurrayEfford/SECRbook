...
This section highlights some examples of SECR in action. The applications fall into two categories: attempts to validate the method empirically (i.e. with field data), and published examples in which they have been employed to answer substantive research questions.
...
We describe four attempts at empirical validation, each with a different approach. The evidence from empirical validation studies is tends to be weak, owing to the wide confidence intervals and methodological constraints. None is entirely convincing, as we shall see.
...
Although broadly reassuring, the brushtail possum study had weaknesses. The live-trapping data were compromised by tag loss (documented in **secr**), the landward boundary of the removal area was somewhat arbitrary, and sampling may have been inadequate to represent density variation across the peninsula (see also following).
