...
fraction is small (e.g., repeat detections rare). Binary data are less prone to 
problems from the non-independence of repeated visits to a detector, especially when a few individuals generate many repeat detections. Binary models also tend to be faster to fit and dodge the question of what distribution should be used for the counts.
:::
