...
Efford, M. G. and Schofield, M. R. (2024) Spatially explicit capture--recapture. A handbook of statistical methods. *Zenodo* https://doi.org/10.5281/zenodo.XXXX

## Feedback

This is work in progress. If you find an error or would like to make a suggestion, please raise an issue on [GitHub](https://github.com/MurrayEfford/SECRbook) or contact the authors directly.  
...
-   Jared Laufenburg black bears @sec-habitat
