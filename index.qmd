...
Other R packages for SECR may be found outside CRAN. A distinct maximum-likelihood implementation by @srl19 is available on GitHub (https://github.com/jaroyle/oSCR). An open-population package by Richard Glennie ([openpopscr](https://github.com/r-glennie/openpopscr)) is also available on GitHub.
...
Ian Durbach, Brian Gerber, Dan Linden, Cyril Milleret, Joanne Potts, and Rahel Sollmann gave helpful comments on earlier versions of some chapters. For help with particular chapters I especially thank Rahel (@sec-assumptions) and Ian (@sec-studydesign). Errors remain my own.
