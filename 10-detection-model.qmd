...
| h2 | 2-class mixture | [finite mixture model](05-theory-special-topics.qmd#sec-finite-mixtures) with 2 latent classes |
...
<!-- [Hybrid mixture models](05-theory-special-topics.qmd#sec-hybrid-mixtures) allow some or all individuals to be assigned permanently to a group (mixture class), while other individuals (ideally a minority) may be of unknown class. -->
