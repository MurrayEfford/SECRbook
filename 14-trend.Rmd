...
Simple trend analysis may be achieved with a particular coding of the session factor as described in earlier versions of [secr-multisession.pdf]. The more flexible methods described here allow the direct estimation of $\lambda_t$, possibly including covariate effects. The newer methods require **secr** $\ge 4.6.2$ 2023-09-30.
