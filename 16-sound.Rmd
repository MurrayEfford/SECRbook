...
```
```{r sound fit 1, cache = TRUE, strip.white=TRUE}
setNumThreads(7)
...
```{r sound fit 2, eval = TRUE, cache = TRUE}
...
```
```{r attenuationplot, fig.width=3.5, fig.height=3.5}
...
```{r detectionfunction, fig.width=4, fig.height=3}
par(mar=c(5,5,2,2), bty = 'l')
...
```{r bimodalityplot, echo = TRUE, eval = TRUE, cache = TRUE, fig.width=4, fig.height=4}
