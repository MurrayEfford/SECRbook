...
Unknown identity can be handled in SECR-like probability models. These generally lack power unless supplemented by detections of known individuals or telemetry (references in @sec-telemetry). Bias due to ghost individuals may be reduced in some circumstances by modelling only detection histories with more than one detection [@Kodi2024].
...
2. Identification |||
&nbsp;&nbsp;&nbsp;[2a. Inadequate marks](#sec-shadow)          |![**](figures/yob54.png)| -ve RB($\hat D$) when high probability of identity| @Augustine2020 |
&nbsp;&nbsp;&nbsp;[2b. Marks corrupted](#sec-ghost)            |![*](figures/yob52.png)|  | |
3. Home range HR |||
