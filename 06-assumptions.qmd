...
The SECR probability models of @sec-theory that underlie the methods in this book incorporate certain assumptions. The validity and reliability of the methods therefore depend to an extent on how well the field data meet the assumptions. We list these before assessing their impact in practice - the topic of [robustness](#sec-robustness). 
...
#|   $\phi = 1$ corresponds to a closed population.
...
### Assumption 3c: Locations independent within home range {#sec-independentwithinhr .unnumbered}
...
### Assumption 3d. Home ranges stationary {#sec-hrstationary .unnumbered}
...
### 5a. Individuals are detected independently {#sec-independentindividuals .unnumbered}
...
### 5b. Detections of an individual are independent {#sec-serialindependence .unnumbered}
...
In the basic SECR model of @sec-theory the next detection of an individual may happen anywhere in its home range, regardless of where it was last detected. More biologically realistic patterns of movement lead to sequential dependence of locations.
...
&nbsp;&nbsp;&nbsp;[2b. Marks corrupted](#sec-ghost)            |![*](figures/yob53.png)|  | |
&nbsp;&nbsp;&nbsp;[2c. Tags lost](#sec-tagloss)            |![*](figures/yob52.png)| +ve RB($\hat D$) when high rate or long study | @Kodi2024 |
3. Home range HR |||
&nbsp;&nbsp;&nbsp;[3a. AC not independent](#sec-ACindependent) |![.](figures/yob51.png)||
&nbsp;&nbsp;&nbsp;[3b. HR non-circular](#sec-hrcircular)       |![*](figures/yob5s14.png)| severe RB($\hat D$) when HR align with detectors| anisotropic model |
&nbsp;&nbsp;&nbsp;[3c. Location autocorrelated](#sec-independentwithinhr)      |![.](figures/yob51.png)||
&nbsp;&nbsp;&nbsp;[3d. HR non-stationary](#sec-hrstationary)   |![.](figures/yob51.png)|||
...
&nbsp;&nbsp;&nbsp;[4c. Individual heterogeneity](#sec-individualheterogeneity) |![*](figures/yob52.png)| RB($\hat D$) nonlinear on CV(a) | covariate, finite mixture | 
&nbsp;&nbsp;&nbsp;[4d. Detector heterogeneity](#sec-homogeneityofdetectors)    |![*](figures/yob5s13.png)| | covariate, GRF |
5. Independence |||
&nbsp;&nbsp;&nbsp;[5a. Individuals interact](#sec-independentindividuals)      |![*](figures/yob51.png)| | @Efford2023 |
&nbsp;&nbsp;&nbsp;[5b. Serial dependence](#sec-serialindependence)             |![.](figures/yob51.png) | ||
...
2. Identification |||
&nbsp;&nbsp;&nbsp;[2a. Inadequate marks](#sec-shadow)          |![**](figures/yob52.png)| -ve RB($\hat D$) when high probability of identity | @Augustine2020 |
&nbsp;&nbsp;&nbsp;[2b. Marks corrupted](#sec-ghost)            |![*](figures/yob52.png)| +ve RB($\hat D$) when high rate or long study | @Kodi2024 |
