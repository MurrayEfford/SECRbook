...
The SECR probability models of @sec-theory that underlie the methods in this book incorporate certain assumptions. The validity and reliability of the methods therefore depends to an extent on how well the field data meet the assumptions. We list these before assessing their impact in practice - the topic of [robustness](#robustness). 
...
Restrictive assumptions often may be relaxed under specific extensions to the SECR model, including the various 'submodels' of @sec-detection. We omit one further assumption: that the probability of detection declines to zero for AC at the edge of the habitat mask unless it is naturally bounded. This is addressed in the analysis by correct choice of [detection function](10-detection-model.qmd#sec-detectfn) and buffer or mask (@sec-habitat).
...
: Robustness of SECR models to breaches of assumptions. {#tbl-robustness tbl-colwidths="[30,5,42,23]" .sm}

|||||||||
|--|--|--|--|--|--|--|--|--|
| **Legend** Split colours indicate that the effect is generally weak or ignorable, but in some circumstances it is damaging if not modelled. |![.](figures/yob51.png) | ignorable | ![](figures/yob52.png) | minor | ![.](figures/yob53.png) | major |![.](figures/yob54.png) | severe |

: {.borderless tbl-colwidths="[40, 5,10,5,10,5,10,5,10]" .sm}
...
|||||
2. Identification |||
&nbsp;&nbsp;&nbsp;[2a. Inadequate marks](#sec-shadow)          |![**](figures/yob54.png)| | @Augustine2020 |
&nbsp;&nbsp;&nbsp;[2b. Marks corrupted](#sec-ghost)            |![*](figures/yob52.png)|  | |
|||||
3. Home range HR |||
&nbsp;&nbsp;&nbsp;[3a. AC not independent](#sec-ACindependent) |![.](figures/yob51.png)||
&nbsp;&nbsp;&nbsp;[3b. HR non-circular](#sec-hrcircular)       |![*](figures/yob5s14.png)| severe RB($\hat D$) when HR align with detectors| @Murphy2025 |
&nbsp;&nbsp;&nbsp;[3c. Location autocorrelated](#sec-independentwithinhr)      |![.](figures/yob51.png)||
&nbsp;&nbsp;&nbsp;[3d. HR non-stationary](#sec-hrstationary)   |![.](figures/yob51.png)|||
|||||
4. Constant parameters |||
...
|||||
5. Independence ||
&nbsp;&nbsp;&nbsp;[5a. Individuals interact](#sec-independentindividuals)      |![*](figures/yob51.png)| | **ipsecr** |
&nbsp;&nbsp;&nbsp;[5b. Serial dependence](#sec-serialindependence)             |![.](figures/yob51.png) | ||

: Robustness of SECR models to breaches of assumptions. {#tbl-robustness tbl-colwidths="[35,5,37,23]" .sm}

|||||||||
|--|--|--|--|--|--|--|--|--|
| **Legend** |![.](figures/yob51.png) | ignorable | ![](figures/yob52.png) | minor | ![.](figures/yob53.png) | major |![.](figures/yob54.png) | severe |

: {.borderless tbl-colwidths="[20, 5,10,5,10,5,10,5,10]" .sm}  
Split colours indicate that the effect is generally weak or ignorable, but in some circumstances it is damaging if not modelled.
