...
One consequence of autocorrelated movement is that the overall spatial scale increases with the duration and decreases with autocorrelation. With respect to telemetry, @Otis1999[^footnote2] concluded that autocorrelation *per se* did not bias inference so long as summary statistics were not generalized beyond the temporal sampling frame: 

[^footnote2]: This interpretation was endorsed by @Fieberg2007, but disputed by @Noonan2019.
